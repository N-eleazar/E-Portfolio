    ...
    <div class="container-fluid">
      <header>
        ...
        <div class="row banniere">
          <div class="title"></div>
          <img src="images/banniere-workplace.webp" alt="" />
        </div>
      </header>
      <section>
        <article>
        ...
        <article>
          ...
          <aside class="row">
            <div class="col-10 col-md-5">
              ...
              <li>Réaliser la maquette d'une application web responsive</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated progress-bar-animated bg-success"
                  role="progressbar"
                  style="width: 100%"
                  aria-valuenow="100"
                  aria-valuemin="0"
              ...
              <br />
              <li>Utiliser Git et Github pour gérer son code source</li>
              <div class="progress">
                <div
              ...
              <br />
              <li>S'initier à la programmation avec Javascript</li>
              <div class="progress">
                <div
              ...
              <br />
              <li>Dynamiser vos sites web avec Javascript</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated bg-info"
                  role="progressbar"
              ...
              <br />
              <li>Développer une application web avec React.js</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated bg-info"
                  role="progressbar"
              ...
              <br />
              <li>Créer un site web avec le CMS Wordpress</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated bg-info"
                  role="progressbar"
              ...
              <br />
              <li>Déployer son application web avec Heroku</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated bg-info"
                  role="progressbar"
            ...
            <div class="col-10 col-md-5">
              ...
              <li>Créer et administrer une base de données</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated bg-danger"
                  role="progressbar"
              ...
              <br />
              <li>Développer des sites web dynamiques avec PHP</li>
              <div class="progress">
                <div
              ...
              <br />
              <li>Créer une application web avec le framework Symfony</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated bg-info"
                  role="progressbar"
              ...
              <br />
              <li>Développer une application mobile avec React Native</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated bg-info"
                  role="progressbar"
              ...
              <br />
              <li>Créer un plugin Wordpress</li>
              <div class="progress">
                <div
                  class="progress-bar progress-bar-striped progress-bar-animated bg-info"
                  role="progressbar"
