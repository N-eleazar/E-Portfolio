...
<head>
 ...
 <link rel="stylesheet" href="css_files/w3.css">
...
<body>
  <div class="container-fluid">
    ...
    <!--   Navbar   -->  
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="#myself">Présentation</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="#level">Competences</a>
                </li>
                <li class="nav-item">
      ...
      <div class="col col-2">
        <button type="button" class="scroll" onclick="scrollToTop()">Scroll Top</button>
      </div>
    </header>
          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  <td colspan="10"></td>
                 <td class="table-primary"colspan="10">S'initier à la base de données.</td>
                </tr>
                <tr><td colspan="20"></td></tr>
                <tr>
